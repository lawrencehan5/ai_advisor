...
QUESTIONS = [
    ...
    },
    {
        ...
        "message": "How much are you looking to invest initially?",
        "type": "freetext",
        "hint": "e.g. $10,000",
    },
    {
    ...
    },
    {
        ...
        "message": "Last question — anything else I should know? ESG preferences, upcoming big expenses, tax situations, constraints?",
        "type": "freetext",
...
def brand():
    st.markdown(
        '<div class="brand-bar">◆ <span>Advisor</span> · AI Portfolio Intelligence</div>',
        unsafe_allow_html=True,
    )
