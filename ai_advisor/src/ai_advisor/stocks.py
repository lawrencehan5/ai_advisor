...
APPROVED_ETFS = [
    ...
    {"ticker": "PPLT", "name": "Invesco DB Precious Metals Fund - Platinum Shares"},
    {"ticker": "PDBC", "name": "Invesco Optimum Yield Diversified Commodity Strategy No K-1 ETF"},
    {"ticker": "GSG", "name": "iShares Goldman Sachs Commodity-Indexed Trust"},
    ...
    {"ticker": "INDA", "name": "iShares India ETF"},
    ...
    {"ticker": "EZU", "name": "iShares Core MSCI Eurozone ETF"},
    ...
    {"ticker": "XIU.TO", "name": "iShares S&P/TSX 60 Index ETF"},
    {"ticker": "VCN.TO", "name": "Vanguard FTSE Canada All Cap Index ETF"},
    {"ticker": "VDY.TO", "name": "Vanguard Canadian High Dividend Yield Index ETF"},
    {"ticker": "XRE.TO", "name": "iShares S&P/TSX Capped REIT Index ETF"},
    {"ticker": "XCG.TO", "name": "iShares Core MSCI Canada ETF"},
