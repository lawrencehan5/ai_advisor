...
APPROVED_ETFS = [
    ...
    {"ticker": "XIU", "name": "iShares S&P/TSX 60 Index ETF"},
    {"ticker": "VCN", "name": "Vanguard FTSE Canada All Cap Index ETF"},
    {"ticker": "VDY", "name": "Vanguard Canadian High Dividend Yield Index ETF"},
    {"ticker": "XRE", "name": "iShares S&P/TSX Capped REIT Index ETF"},
    {"ticker": "XCG", "name": "iShares Core MSCI Canada ETF"},
